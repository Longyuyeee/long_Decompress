<template>
  <div class="compress-view p-6 max-w-4xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">压缩文件</h1>
    ...
    <div v-if="selectedFiles.length > 0" class="mt-8 space-y-4">
      ...
      <button @click="startCompress" class="glass-button-primary w-full py-3 mt-4">开始压缩</button>
    </div>
  </div>
</template>
