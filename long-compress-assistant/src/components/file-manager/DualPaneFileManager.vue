...
@media(max-width:900px){.file-manager{overflow-x:hidden;overflow-y:auto}.pane-grid{grid-template-columns:1fr;grid-template-rows:30rem 30rem}.status-pill{display:none}.transfer-bar{flex-wrap:wrap}.file-head,.file-row{grid-template-columns:minmax(8rem,1fr) 4.5rem}.file-head span:last-child,.file-row>span:last-child{display:none}}
</style>
