...
- 当前是候选而非公开稳定版。下一步必须依次完成本地全量门禁、干净 CI 精确 NSIS、`v1.1.16 → 候选` 安装生命周期、受保护主线合入、annotated tag、四项公开资产、回下载与真实应用内更新；任一步失败均不得宣称 `v1.1.17` 已发布。详见 [RELEASE_AUDIT_1.1.17.md](RELEASE_AUDIT_1.1.17.md)。
