...
## 2026-09-02 v1.2.2 后续 PDF 空态与窗口外框修复
...
- 独立未收口项：真实 Tauri 响应式门禁在 920×620 的解压详情发现 2 px 横向溢出，尚未为此扩大本轮范围。下一步应先建立独立失败证据并修复 box sizing，不能放宽门禁。当前版本仍为 `1.2.2`，尚未打包或创建新 Release；完整审计见 [PDF_FRAMELESS_SHELL_AUDIT.md](PDF_FRAMELESS_SHELL_AUDIT.md)。
