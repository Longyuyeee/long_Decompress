...
- D-01 与 D-02 现已关闭，但 PDF 转换命令仍冻结。D-02.2 的真实 Windows Tauri 表单/签名/密码/源哈希/布局门禁差异为 0；下一唯一接续点为 D-03.1 执行事务基础，详见 [D02_2_PDF_RISK_CONFIGURATION_AUDIT.md](D02_2_PDF_RISK_CONFIGURATION_AUDIT.md)。
