...
- D-01 现已关闭，但 PDF 转换命令和 UI 仍冻结。下一唯一接续点为 D-02 输入分析与前端配置，详见 [D01_2_2_INSTALLED_QPDF_AND_SIGNED_DELTA_AUDIT.md](D01_2_2_INSTALLED_QPDF_AND_SIGNED_DELTA_AUDIT.md)。
