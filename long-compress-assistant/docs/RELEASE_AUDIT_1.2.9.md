...
本机产物只用于身份、可构建性和哈希审计；正式 updater 与公开资产必须由 annotated `v1.2.9` 标签触发的干净 GitHub Actions Runner 重新生成。

## 发布边界

- 正式状态、合并提交、标签、CI、Release workflow、公开资产大小与 SHA-256 将在相应步骤完成后写回本文件。
