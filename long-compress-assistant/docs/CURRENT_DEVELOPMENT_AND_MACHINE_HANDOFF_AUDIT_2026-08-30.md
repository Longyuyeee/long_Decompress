...
> 2026-09-01 增量状态：D-02、D-03、D-04.1 至 D-04.3 均已完成，D 节点关闭并由 `v1.1.17` 公开发布。精确 NSIS 生命周期 54/54、生产 PDF 工作区 23/23、正式四资产回下载和公开 `v1.1.16 → v1.1.17` 更新 24/24 均通过；当前开发路线阶段已收口，完整证据见 [RELEASE_AUDIT_1.1.17.md](RELEASE_AUDIT_1.1.17.md)。
