...
use windows::Win32::System::Com::{
    CoTaskMemFree, IBindCtx, IClassFactory, IClassFactory_Impl,
};
use windows::Win32::UI::Shell::{
    IEnumExplorerCommand, IEnumExplorerCommand_Impl, IExplorerCommand,
    IExplorerCommand_Impl, IShellItemArray, ECF_DEFAULT, ECF_HASSUBCOMMANDS,
    ECS_DISABLED, ECS_ENABLED, ECS_HIDDEN, SHStrDupW, SIGDN_FILESYSPATH,
};
...
const REGISTRATION_KEY: &str =
    r"Software\Classes\CLSID\{D4BBA0B2-6A58-4D40-8B79-BA50C54E8D4A}";
const CREATE_NO_WINDOW: u32 = 0x0800_0000;

const ARCHIVE_EXTENSIONS: &[&str] = &[
    "zip", "zipx", "7z", "rar", "tar", "gz", "gzip", "bz2", "bzip2", "xz",
    "zst", "zstd", "lzma", "tgz", "tpz", "tbz", "tbz2", "txz", "tzst", "iso",
    "img", "dmg", "wim", "vhd", "vhdx", "cab", "msi", "deb", "rpm", "lzh", "lha",
    "arj", "chm", "xar", "cpio", "squashfs", "sfs", "udf", "jar", "xpi", "odt",
    "ods", "docx", "xlsx", "pptx", "epub", "ipa", "apk", "appx", "ova", "aes",
];
...
impl IEnumExplorerCommand_Impl for CommandEnumerator_Impl {
    ...
    fn Skip(&self, count: u32) -> Result<()> {
        ...
        *position = position.saturating_add(count as usize).min(SUBCOMMANDS.len());
        Ok(())
    }
...
impl IClassFactory_Impl for ClassFactory_Impl {
    fn CreateInstance(
        ...
        let command: IExplorerCommand = ShellCommand::new(CommandKind::Root).into();
...
pub unsafe extern "system" fn DllGetClassObject(
    ...
    if unsafe { *class_id } != EXPLORER_COMMAND_GUID {
...
mod tests {
    ...
    use windows::core::{Interface, IUnknown, GUID};
    ...
    use super::{
        is_archive_path, CommandKind, DllCanUnloadNow, DllGetClassObject, SUBCOMMANDS,
        EXPLORER_COMMAND_CLSID, EXPLORER_COMMAND_GUID,
    };
    ...
    fn native_menu_contains_expected_commands() {
        ...
        assert_eq!(SUBCOMMANDS[6], CommandKind::CompressCustom);
    ...
    fn com_factory_creates_root_and_enumerates_subcommands() {
        unsafe {
            ...
            let mut commands: [Option<IExplorerCommand>; 7] = std::array::from_fn(|_| None);
            let mut fetched = 0;
